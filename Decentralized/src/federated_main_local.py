...
if __name__ == '__main__':
	...
	#local_weights = []
	#local_losses = []
	local_weights = torch.load(path_project + '/params/param_Client[{}]_weights.pt'.format(args.client))
	local_losses = torch.load(path_project + '/params/param_Client[{}]_weights.pt'.format(args.client))
